# Qwen3 decoder layer 0, ordinal 16: update_paged_attention_kvcache
...
#
# Qwen3 meaning: write key shard into simulated NUMA KV cache according to slot_mapping owner/local_slot
# nncase kind: compute. This ordinal is a direct compute op lowered to one Triton kernel family.
# Arguments: buffer_36, kvCache
#
