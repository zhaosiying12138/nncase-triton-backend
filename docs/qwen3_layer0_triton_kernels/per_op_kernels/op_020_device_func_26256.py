# Qwen3 decoder layer 0, ordinal 20: device_func_26256
...
#
# Qwen3 meaning: o_proj: attention output [S,2048] -> hidden [S,1024]
...
# Arguments: buffer_43, const_44, dim_var, buffer_45
#
