# Qwen3 decoder layer 0, ordinal 14: ro_pe
...
#==============================================================================================
# Kernel: _nncase_pe_rope_rank4_kernel
# Implements here: applies rotary embedding using cos/sin tables to Q or K.
# NUMA model: The kernel is PE-local; cos/sin can be broadcast but the output stays in out_ptrs[pe].
#==============================================================================================
